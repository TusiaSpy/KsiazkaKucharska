...
public abstract class Meal {
	...
	public String toString() {
		return "Danie [=" + "czasPrzygotowania=" + preparationTime + ", dlaIluOsob=" + NumberOfPeople + ", sposobPrzygotowania="
				+ preparation + ", stopienTrudnosci=" + complication + ", skladniki=" + ingredients + "]";}
